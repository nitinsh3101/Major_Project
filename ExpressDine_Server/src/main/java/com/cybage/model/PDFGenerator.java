...
//	
	...
	public void generatePdfReport() {
		...
		try {
			...
			addFooter(document);
			document.close();
			System.out.println("------------------Your Food PDF Report is ready!-------------------------");
...
private void getDbData(PdfPTable table1) {
		...
		List<Food> list1 = foodRepository.findAll();
		for (Food food : list1) {
			...
			//table.addCell(user.getUser_id().toString());
			table1.addCell(food.getName().toString());
			table1.addCell(food.getCategory());
