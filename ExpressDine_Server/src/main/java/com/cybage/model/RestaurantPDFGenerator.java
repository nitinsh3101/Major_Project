...
@Component("pdfGenerator2")
public class RestaurantPDFGenerator {
...
//	
	...
	public void generatePdfReport() {
		...
		try {
			...
			addFooter(document);
			document.close();
			System.out.println("------------------Your Restaurant PDF Report is ready!-------------------------");
...
//	}
	...
	private void createTable(Document document, int noOfColumns) throws DocumentException {
		...
		PdfPTable table1 = new PdfPTable(noOfColumns);
...
//			
//			//table.addCell(user.getUser_id().toString());
...
private void getDbData(PdfPTable table1) {
		...
		for (Restaurant restaurant : list1) {
			...
			//table.addCell(user.getUser_id().toString());
			table1.addCell(restaurant.getName());
			table1.addCell(restaurant.getAddress());
			table1.addCell(restaurant.getPhone());
			table1.addCell(String.valueOf(restaurant.getOfferPercent()));
			
//			table1.addCell(String.valueOf(food.getPrice()));
//			table1.addCell(String.valueOf(food.getDeliveryTime()));
